...
#define IS_V3_OVERRIDE(kb)              ((kb)->product == P_K68 || (kb)->product == P_STRAFE_NRGB_2 || (kb)->product == P_K70_MK2 || (kb)->product == P_K70_MK2SE || (kb)->product == P_STRAFE_MK2 || IS_DARK_CORE(kb))
...
#define USES_FILE_HWSAVE(kb)            ((kb)->product == P_K95_PLATINUM || (kb)->product == P_K70_MK2 || (kb)->product == P_K70_MK2SE || (kb)->product == P_STRAFE_MK2 || (kb)->product == P_GLAIVE || (kb)->product == P_SCIMITAR_PRO || (kb)->product == P_K70_MK2LP || IS_K63_WL(kb) || IS_DARK_CORE(kb))
